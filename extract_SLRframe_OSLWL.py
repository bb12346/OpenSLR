...
if __name__ == "__main__":
    ...
    # )
    parser.add_argument(
        "--video_path", default='/data/SSL/PUBLIC/OSLWL_VAL_SET_VIDEOS/', type=str, help="video_path."
    )
    parser.add_argument(
        "--save_path", default='/root/SSL/data/OSLWL_VAL_SET_VIDEOS_sorted_frame/', type=str, help="save_path."
    )
