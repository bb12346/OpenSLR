...
class SLR_Pose(BaseModel):

    def __init__(self, *args, **kargs):
        super(SLR_Pose, self).__init__(*args, **kargs)
    ...
    def build_network(self, model_cfg):
        ...
        self.Head0 = SeparateFCs(27*3, channels[2], channels[2])
    ...
    def forward(self, inputs):
        ...
        xl8 = xl8.mean(2)
        # print('-xl8 -',xl8.shape)
        x = torch.cat((xl8, xl9, xl10), dim=2)
        # outs = x.unsqueeze(1)
        # print('-outs1-',outs.shape)
        # outs = outs.permute(1, 0, 2).contiguous()  # [p, n, c]
        outs = x.permute(2, 0, 1).contiguous()  # [p, n, c]
